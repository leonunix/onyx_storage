...
impl EngineMetrics {
    pub fn snapshot(&self) -> EngineMetricsSnapshot {
        ...
        EngineMetricsSnapshot {
            ...
            lv3_write_batch_ns: load(&self.lv3_write_batch_ns),
            lv3_write_batch_ns_max: load(&self.lv3_write_batch_ns_max),
            lv3_write_batch_inflight: load(&self.lv3_write_batch_inflight),
            lv3_write_batch_inflight_max: load(&self.lv3_write_batch_inflight_max),
            ...
            dedup_promote_skipped_inflight: load(&self.dedup_promote_skipped_inflight),
            ...
            flush_commit_worker_pipeline_issues: load(&self.flush_commit_worker_pipeline_issues),
            flush_commit_worker_pipeline_depth_max: load(
                &self.flush_commit_worker_pipeline_depth_max,
            ),
            flush_commit_worker_pipeline_block_drains: load(
                &self.flush_commit_worker_pipeline_block_drains,
            ),
            ...
            gc_compactable_dead_blocks: load(&self.gc_compactable_dead_blocks),
            gc_slot_evac_candidates: load(&self.gc_slot_evac_candidates),
            gc_slot_evac_blocks: load(&self.gc_slot_evac_blocks),
            gc_slot_evac_incomplete_skips: load(&self.gc_slot_evac_incomplete_skips),
            gc_slot_evac_cost_cap_skips: load(&self.gc_slot_evac_cost_cap_skips),
            ...
            gc_lineage_idempotent_frees: load(&self.gc_lineage_idempotent_frees),
            pba_reclaim_stuck: load(&self.pba_reclaim_stuck),
            pba_blocks_retired: load(&self.pba_blocks_retired),
            gc_reclaim_grace_deferred: load(&self.gc_reclaim_grace_deferred),
            gc_reclaim_rc_rejected: load(&self.gc_reclaim_rc_rejected),
            gc_retired_blocks_depth: load(&self.gc_retired_blocks_depth),
            heat_refresh_cycles: load(&self.heat_refresh_cycles),
            heat_refresh_lbas_scanned: load(&self.heat_refresh_lbas_scanned),
            heat_bumps: load(&self.heat_bumps),
            heat_sweeps_completed: load(&self.heat_sweeps_completed),
            heat_refresh_adaptive_cycles: load(&self.heat_refresh_adaptive_cycles),
            gc_heat_deferred_extents: load(&self.gc_heat_deferred_extents),
            gc_heat_confirmed_extents: load(&self.gc_heat_confirmed_extents),
            gc_heat_scans_skipped: load(&self.gc_heat_scans_skipped),
            gc_heat_force_confirm_passes: load(&self.gc_heat_force_confirm_passes),
            gc_heat_defer_suppressed: load(&self.gc_heat_defer_suppressed),
            gc_heat_cold_tail_pushed: load(&self.gc_heat_cold_tail_pushed),
            gc_heat_cold_tail_dropped: load(&self.gc_heat_cold_tail_dropped),
            ...
            dedup_cold_tail_remaps: load(&self.dedup_cold_tail_remaps),
            dedup_cold_tail_drained: load(&self.dedup_cold_tail_drained),
            dedup_orphan_demoted: load(&self.dedup_orphan_demoted),
            dedup_orphan_retired: load(&self.dedup_orphan_retired),
            dedup_orphan_skipped_hot: load(&self.dedup_orphan_skipped_hot),
            dedup_scrub_retired: load(&self.dedup_scrub_retired),
            dedup_ref_bitmap_published: load(&self.dedup_ref_bitmap_published),
...
pub struct EngineMetricsSnapshot {
    ...
    pub lv3_write_batch_ns: u64,
    pub lv3_write_batch_ns_max: u64,
    pub lv3_write_batch_inflight: u64,
    pub lv3_write_batch_inflight_max: u64,
    ...
    pub dedup_promote_skipped_inflight: u64,
    ...
    pub flush_commit_worker_pipeline_issues: u64,
    ...
    pub gc_compactable_dead_blocks: u64,
    pub gc_slot_evac_candidates: u64,
    pub gc_slot_evac_blocks: u64,
    pub gc_slot_evac_incomplete_skips: u64,
    pub gc_slot_evac_cost_cap_skips: u64,
    ...
    pub gc_lineage_idempotent_frees: u64,
    pub pba_reclaim_stuck: u64,
    pub pba_blocks_retired: u64,
    pub gc_reclaim_grace_deferred: u64,
    pub gc_reclaim_rc_rejected: u64,
    pub gc_retired_blocks_depth: u64,
    pub heat_refresh_cycles: u64,
    pub heat_refresh_lbas_scanned: u64,
    pub heat_bumps: u64,
    pub heat_sweeps_completed: u64,
    pub heat_refresh_adaptive_cycles: u64,
    pub gc_heat_deferred_extents: u64,
    pub gc_heat_confirmed_extents: u64,
    pub gc_heat_scans_skipped: u64,
    pub gc_heat_force_confirm_passes: u64,
    pub gc_heat_defer_suppressed: u64,
    pub gc_heat_cold_tail_pushed: u64,
    pub gc_heat_cold_tail_dropped: u64,
    ...
    pub dedup_cold_tail_remaps: u64,
    pub dedup_cold_tail_drained: u64,
    pub dedup_orphan_demoted: u64,
    pub dedup_orphan_retired: u64,
    pub dedup_orphan_skipped_hot: u64,
    pub dedup_scrub_retired: u64,
    pub dedup_ref_bitmap_published: u64,
...
impl EngineMetricsSnapshot {
    pub fn saturating_sub(&self, earlier: &Self) -> Self {
        ...
        build_sub! {
            ...
            lv3_write_batch_ns,
            lv3_write_batch_ns_max,
            lv3_write_batch_inflight,
            lv3_write_batch_inflight_max,
