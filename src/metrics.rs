...
impl EngineStatusSnapshot {
    pub fn render_text(&self) -> String {
        ...
        let _ = writeln!(
            out,
            "flush_writer_meta: commits={} lbas={} l2p_lock_wait={} l2p_lock_hold={} l2p_lock_acquires={}",
