...
pub struct EngineMetrics {
    ...
    pub flush_writer_hole_detect_ns: AtomicU64,
...
impl Default for EngineMetrics {
    fn default() -> Self {
        Self {
            ...
            flush_writer_hole_detect_ns: AtomicU64::new(0),
...
impl EngineMetrics {
    pub fn snapshot(&self) -> EngineMetricsSnapshot {
        ...
        EngineMetricsSnapshot {
            ...
            flush_writer_hole_detect_ns: load(&self.flush_writer_hole_detect_ns),
...
pub struct EngineMetricsSnapshot {
    ...
    pub flush_writer_hole_detect_ns: u64,
...
impl EngineStatusSnapshot {
    pub fn render_text(&self) -> String {
        ...
        let _ = writeln!(
            out,
            "front_write_ns: zone_submit={} zone_worker={} append_total={} append_prepare={} append_log_write={} append_wait_durable={} sync_batches={} sync_batch_ns={} sync_sleep_ns={} sync_epochs={}",
        ...
        let _ = writeln!(
            out,
            "flush_writer_ns: total={} alloc={} io={} meta={} cleanup={} dedup_index={} hole_detect={} mark_flushed={}",
            ...
            self.metrics.flush_writer_hole_detect_ns,
