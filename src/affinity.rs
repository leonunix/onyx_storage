...
impl AffinityLayout {
    fn from_config(config: &ThreadingConfig) -> Option<Self> {
        ...
        Some(Self {
            ...
            flusher_dedup_register: CpuSet::parse(&config.flusher_dedup_register_cpus),
    ...
    fn cpus_for(&self, role: ThreadRole) -> &CpuSet {
        match role {
            ...
            ThreadRole::FlusherDedupRegister => &self.flusher_dedup_register,
